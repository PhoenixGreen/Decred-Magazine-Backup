...
import { parseRequest } from './requestDataDeprecated.js';
export { extractRequestData, parseRequest } from './requestDataDeprecated.js';
import { extractRequestData, isAutoSessionTrackingEnabled, addRequestDataToEvent, flush } from './sdk.js';
...
function requestHandler(
  ...
  return function sentryRequestMiddleware(
    ...
    if (options && 'include' in options) {
      backwardsCompatibleEventProcessor = (event) => addRequestDataToEvent(event, req, options);
    } else {
            backwardsCompatibleEventProcessor = (event) => parseRequest(event, req, options );
    }
